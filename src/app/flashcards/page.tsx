    ...
    <div className="max-w-3xl mx-auto space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div
              ...
              className="cursor-pointer min-h-[300px] rounded-2xl bg-gradient-to-br from-purple-600/10 via-blue-500/5 to-purple-600/10 border border-purple-500/20 p-8 md:p-12 flex items-center justify-center text-center hover:from-purple-600/20 hover:to-blue-500/20 transition-all duration-300"
            >
              <div>
        ...
        <div className="flex items-center justify-center gap-4 mt-4 text-xs text-muted-foreground">
          ...
          <span className="flex items-center gap-1">
            <Brain className="h-3 w-3 text-purple-400" /> Remaining: {cards.length - currentIndex}
          </span>
        </div>
      </motion.div>
    </div>
