                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`p-6 rounded-2xl border-2 text-center transition-all ${
                      theme === "dark" ? "border-purple-500 bg-purple-500/10" : "border-border hover:border-purple-500/30"
                    }`}
                  >
                    <Moon className="h-8 w-8 mx-auto mb-2 text-purple-400" />
                  ...
                  <button
                    ...
                    className={`p-6 rounded-2xl border-2 text-center transition-all ${
                      theme === "light" ? "border-purple-500 bg-purple-500/10" : "border-border hover:border-purple-500/30"
                    }`}
                  >
