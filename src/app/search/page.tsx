            ...
            <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="all" className="space-y-4">
                {searchResults.lessons.slice(0, 3).map((l) => (
                  <SearchResultCard key={l.id} href={`/lessons/${l.id}`} icon={BookOpen} color="from-purple-600 to-blue-500">
                    <div>
...
function SearchResultCard({
  ...
  return (
    <Link href={href}>
      <Card className="group hover:border-purple-500/30 transition-all cursor-pointer">
        <CardContent className="p-4">
          <div className="flex items-start gap-4">
            ...
            <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-purple-400 group-hover:translate-x-1 transition-all mt-2 flex-shrink-0" />
          </div>
        </CardContent>
      </Card>
    </Link>
