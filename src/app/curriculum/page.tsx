                  ...
                  return (
                    ...
                    >
                      <Link href={`/lessons/${topic.lessons[0]}`}>
                        <Card className="group hover:border-purple-500/30 transition-all duration-300 cursor-pointer">
                          <CardContent className="p-6">
                            <div className="flex items-start gap-4">
                              ...
                              <ArrowRight className="h-5 w-5 text-muted-foreground group-hover:text-purple-400 group-hover:translate-x-1 transition-all flex-shrink-0 mt-2" />
                            </div>
                          </CardContent>
                        </Card>
                      </Link>
